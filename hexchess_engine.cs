...
namespace HexC
{
        ...
        public void Remove(PlacedPiece p)
        {
            foreach (var placed in placedPieces)
            {
                if (placed.DeepEquals(p))
                {
                    ...
                    // hey, um, should this piece be added immediately to the sidelines?
                    // and shouldn't i validate the board all over the fuckin place?
                    // with like this.Validate(); that confirms all is well.
                    return;
                }
            }
    ...
    class Program
    {
        ...
        */
        ...
        public static Board BoardFromWillsBoard(Dictionary<string, string> willBoard)
        {
            Board b = new Board();
        ...
        {
            Board b = BoardFromWillsBoard(willBoard);
